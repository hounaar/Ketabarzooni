...
<head>
    ...
    <link rel="stylesheet" href="/others/portal/forgotpass/css/style.css">
    ...
    <title>پورتال - کتاب ارزونی</title>
</head>
...
<body>
    ...
    <section class="d-flex justify-content-center">
        <form class="container mt-5 border changepassform animate__animated animate__fadeInDown" id="registerform">
            <h1>
                فرم تجدید رمز عبور
            </h1>
            <br/>
            ...
            <div class="form-floating">
                <div class="col confirmText"></div>

                <label for="name">  نام کاربری
                </label>
                <input type="text" class="form-control" id="name" placeholder="نام کاربری حود را وارد نمایید" name="id" required><br/>

                <label for="name">  رمز عبور جدید
                </label>
                <input type="password" class="form-control" id="name" placeholder="رمز عبور جدید خود را وارد کنید" name="newpass" required><br/>

                <label for="name">  تکرار رمز عبور جدید 
                </label>
                <input type="password" class="form-control" id="name" placeholder="رمز عبور جدید خود دوباره را وارد کنید" name="repeat_pass" required><br/>

                <button type="submit" name="change_pass_submit" class="btn btn-primary form-btn mt-5"> تغییر رمز </button>
   ...
   <?php
    ...
    <script type="text/javascript" src="/others/portal/forgotpass/js/changer.js"></script>
