...
<head>
    ...
    <link rel="stylesheet" href="/others/comments/css/style.css">
    ...
    <title> دیدگاه کاربران - کتاب ارزونی</title>
</head>
...
<body>
    ...
    <section class="d-flex justify-content-center">
        <div class="container mt-5 border" id="comments">
...
<hr/>
            ...
            <div class="container cont" data-aos="fade-down">
                <div class="row">
                    <img class="rounded-circle shadow-1-strong mt-2" src="/others/comments/images/avatar.png" alt="avatar" width="60" height="60" />
                    <div>
                        <h6 class="fw-bold mt-2 mr-3 name">شروین بریمانی </h6>
                ...
                <div class="row mt-2">
                    <div class="col desc">
                        سایت خوب و مفیدیه کاره آدمو راه میندازه
                    </div>
                </div>
            </div>
            ...
            <div class="container cont" data-aos="fade-down">
                <div class="row">
                     <img class="rounded-circle shadow-1-strong mt-2" src="/others/comments/images/avatar.png" alt="avatar" width="60" height="60" />
                    <div>
                        <h6 class="fw-bold mt-2 mr-3 name">شیرین بیات </h6>
                        <div class="d-flex align-items-center mb-3">
                            <p class="mb-0 mr-3 date">
                                ۱۰ مهر
                            </p>
            ...
            <div class="container cont" data-aos="fade-down">
                <div class="row">
                     <img class="rounded-circle shadow-1-strong mt-2" src="/others/comments/images/avatar.png" alt="avatar" width="60" height="60" />
                    <div>
                        <h6 class="fw-bold mt-2 mr-3 name">پارسا بشارت </h6>
                        <div class="d-flex align-items-center mb-3">
                            <p class="mb-0 mr-3 date">
                                ۱۸ مهر
                            </p>
                ...
                <div class="row mt-2">
                    <div class="col desc">
                        سایت که عالیست اگه اپلیکیشن هم داشت که دیگه چقد عالی میشد
                    </div>
                </div>
            </div>
            <br/>
            <div class="container cont" data-aos="fade-down">
                <div class="row">
                     <img class="rounded-circle shadow-1-strong mt-2" src="/others/comments/images/avatar.png" alt="avatar" width="60" height="60" />
                    <div>
                        <h6 class="fw-bold mt-2 mr-3 name">سهیلا جوانمرد </h6>
                        <div class="d-flex align-items-center mb-3">
                            <p class="mb-0 mr-3 date">
                                ۲۲ مهر
                            </p>
                ...
                <div class="row mt-2">
                    <div class="col desc">
                        سلام ممنون از تون بابات تمامی زحماتتون
                    </div>
                </div>
            </div>
            <br/>
            <div class="container cont" data-aos="fade-down">
                <div class="row">
                     <img class="rounded-circle shadow-1-strong mt-2" src="/others/comments/images/avatar.png" alt="avatar" width="60" height="60" />
                    <div>
                        <h6 class="fw-bold mt-2 mr-3 name">مهسا حسین زاده </h6>
                        <div class="d-flex align-items-center mb-3">
                            <p class="mb-0 mr-3 date">
                                ۱ آبان
                            </p>
                ...
                <div class="row mt-2">
                    <div class="col desc">
                        تا الان دو تا کتاب درخواست کرده بودم و هردوتاش رو در وقتی که میخواستم تحویل گرفتم. ممنونم ازتون
                    </div>
                </div>
            </div>
            <br/>
            <div class="container cont" data-aos="fade-down">
                <div class="row">
                     <img class="rounded-circle shadow-1-strong mt-2" src="/others/comments/images/avatar.png" alt="avatar" width="60" height="60" />
                    <div>
                        <h6 class="fw-bold mt-2 mr-3 name">محمد ولی نژاد </h6>
                        <div class="d-flex align-items-center mb-3">
                            <p class="mb-0 mr-3 date">
                                ۵ ابان
                            </p>
                ...
                <div class="row mt-2">
                    <div class="col desc">
                        اگه میتونین اپش رو هم برای آیفون و اندروید بسازید
                    </div>
                </div>
            </div>
            <br/>
            <div data-aos="fade-down">
            <p class="section-end">شما هم میتوانید نظرات خود را در قسمت ثبت نظر یا قسمت زیر عنوان کنید.</p>
            <a href="/others/insert_comments/" class="btn btn-outline-info">ثبت نظر</a>
</div>
