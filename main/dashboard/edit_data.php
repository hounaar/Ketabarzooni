...
<body>
            ...
            <div class="container button align-items-center  animate__animated animate__fadeInDown" id="navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="/others/dashboard/request/" >پروفایل من </a>
                        </li>
                        <li class="nav-item">
    ...
    <section class="d-flex justify-content-center">
        <div class="container border animate__animated animate__fadeInDown" id="editdata">
        <form class="needs-validation editdata" method="POST" novalidate>
            ...
            <div class="form-floating">
                ...
                <label for="name"> ایمیل قبلی<i class="fa fa-star"></i>
                </label>
                <input type="text" class="form-control" id="name" placeholder="ایمیل قبلی خود را وارد نمایید" name="oldemail" required><br/>


                <label for="name"> ایمیل جدید<i class="fa fa-star"></i>
                </label>
                <input type="text" class="form-control" id="name" placeholder="ایمیل جدید خود را وارد نمایید" name="newemail" required><br/>

                

                <label for="lastname"> آی دی تلگرام (بدون @ وارد کنید) 
                    <i class="fa fa-star"></i>

                </label>
                <input type="text" class="form-control" id="name" placeholder="ای دی تلگرام خود را وارد نمایید" name="telegramid" required><br/>
                

                <label for="lastname"> شماره تلفن 
                    <i class="fa fa-star"></i>

                </label>
                <input type="text" class="form-control" id="name" placeholder="شماره تلفن خود را وارد نمایید" name="phone" required><br/>


                <label for="lastname">نام کاربری قبلی
                    <i class="fa fa-star"></i>
                </label>
                <input type="text" class="form-control" id="name" placeholder="نام کاربری قبلی  خود را وارد کنید" name="oldid" required><br/>


                <label for="lastname">نام کاربری جدید
                    <i class="fa fa-star"></i>
                </label>
                <input type="text" class="form-control" id="name" placeholder="نام کاربری جدید خود را وارد کنید" name="newid" required><br/>

                <button type="submit" name="submit" class="btn btn-primary form-btn">ویرایش </button>
...
<script type="text/javascript" src="/others/dashboard/editdata/js/updator.js"></script>
