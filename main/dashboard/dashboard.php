...
<body>
    ...
    <section class="d-flex justify-content-center">
        <div class="container mt-5 border animate__animated animate__fadeInDown" id="myprofile">
            <h1>
                پروفایل من
            </h1>
            <hr/>
            ...
            <?php
                ...
                <input type="text" readonly class="form-control" id="name" placeholder="<?php  echo $row['name']; ?>" name="id" required><br/>

                <label for="lastname">نام خانوادگی </label>
                <input type="text" readonly class="form-control" id="name" placeholder="<?php  echo $row['lastname']; ?>" name="id" required><br/>

                <label for="lastname">نام کاربری 
                </label>
                <input type="text" readonly class="form-control" id="name" placeholder="<?php  echo $_SESSION['userid']; ?>" name="id" required><br/>

                <label for="name">ایمیل
                </label>
                <input type="text" readonly class="form-control profileemail" id="name" placeholder="<?php echo $row['email'];  ?>" name="email" required><br/>
                <?php } }?>
            </div>
        </div>
    </section>
