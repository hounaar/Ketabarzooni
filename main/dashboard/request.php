...
$id = $row['id'];
$email = $row['email'];
if(isset($onvan) && isset($subject) && isset($request)){
    $query = "INSERT INTO requests(`name`, `lastname`, `id`, `email`, `onvan`, `subject`, `request`, `date`)
    VALUES ('$name','$lastname','$id','$email','$onvan','$subject','$request','$date')";
    ...
    if($results){
        ...
        swal({
            title: "ناموفق",
            text: " مشکلی در ثبت درخواست شما وجود دارد",
            icon: "error",
            button: "باشه",
        });
        </script>';
...
<section class="d-flex justify-content-center">
    <div class="container border animate__animated animate__fadeInDown" id="request">
    <form class="needs-validation" method="POST" novalidate>
        ...
        <div class="form-floating">
            ...
            <label for="name">عنوان<i class="fa fa-star"></i>
            </label>
            <input type="text" class="form-control" id="name" placeholder="عنوان درخواست خود را وارد کنید" name="onvan" required><br/>
            <label for="lastname">موضوع درخواست 
                <i class="fa fa-star"></i>
            </label>
            <input type="text" class="form-control" id="name" placeholder="موضوع درخواست خود را وارد کنید" name="subject" required><br/>

            <label for="name">متن درخواست<i class="fa fa-star"></i>
            </label>
            <textarea type="text" class="form-control" id="name" placeholder="متن درخواست خود را وارد نمایید" name="request" required></textarea><br/>



            <button type="submit" name="submit" class="btn btn-primary form-btn">ثبت درخواست</button>
