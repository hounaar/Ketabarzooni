...
<head>
    ...
    <link rel="stylesheet" href="/others/orders/css/style.css">
    ...
    <title>فرم ثبت سفارش - کتاب ارزونی</title>
</head>
...
<?php
    ...
    <section class="d-flex justify-content-center">
        <div class="container mt-5 border" id="orderform">
        <form class="needs-validation" method="POST" novalidate>
            ...
            <div class="form-floating animate__animated animate__fadeInDown">
                ...
                <input type="text" class="form-control" id="name" name="phone" placeholder="شماره تلفن همراه خود را وارد نمایید" required><br/>
                ...
                <button type="submit" name="submit" class="btn btn-primary form-btn">ثبت سفارش</button>
