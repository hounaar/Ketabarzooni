...
<head>
    ...
    <link rel="stylesheet" href="/others/portal/signup/css/style.css">
    ...
    <title>پورتال ثبت نام - کتاب ارزونی</title>
</head>
...
<body>
    ...
    <section class="d-flex justify-content-center ">
        <div class="container mt-5 border animate__animated animate__fadeInDown" id="registerform">
        <form class="needs-validation signup" method="POST" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-floating">
                ...
                <button type="submit" name="signup_submit" class="btn btn-primary form-btn mt-5">ثبت نام </button>
                <a href="/others/portal/login/"  class="btn btn-outline-danger form-btn2 mr-5 mt-5">در سایت عضو  هستید؟ وارد شوید</a><br/><br/>
    ...
    <script type="text/javascript" src="/others/portal/signup/js/signup.js"></script>
